...
function related_posts_tags() {
  ...
  if ( $tag_query->have_posts() ) {
    while ( $tag_query->have_posts() ) {
      ...
      $related .= '<div class="uk-width-medium-1-4 uk-width-small-2-4"><a href="' . get_permalink() . '" rel="bookmark" title="Permanent Link to' . get_the_title() . '">' . $img . '</a><h4 class="uk-article-title uk-text-center"><a href="' . get_permalink() . '" rel="bookmark" title="Permanent Link to' . get_the_title() . '">'. get_the_title() .'</a></h4></div>';
